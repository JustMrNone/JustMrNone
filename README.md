...
- **Frameworks & Libraries**: Django, Flask, DRF, React, Material-UI, Bootsrap, Pandas, matplotlib, bookeh, Next.js, Tailwind CSS, ...
- **Tools & Platforms**: Git, Docker, Nginx, Kubernetes, AWS, npm/yarn, Pipenv, Poetry, Jenkins, GitHub Actions, GitLab CI, Sentry, ELK Stack, ...
