...
- **Collaboration Interests**: Developing interactive web applications using Django and React, large-scale data analysis, and conducting research on Quantum Information. 🤝
